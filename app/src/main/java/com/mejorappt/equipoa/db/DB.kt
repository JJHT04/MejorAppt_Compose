...
private const val SQL_CREATE_USER_TABLE = "CREATE TABLE IF NOT EXISTS $USER_TABLE_NAME (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, age INT, gender TEXT, iconHappy INT, iconAnnoyed INT)"
